...
const UserForm = ({ handleSubmit }: Props) => {
  ...
  return (
    <form
      className="py-4 px-9 rounded-xl opacity-90 flex items-end text-sm justify-center gap-6 bg-brown-200 mobile:flex-col mobile:items-start mobile:gap-3 mobile:text-xs tablet:text-xs"
      onSubmit={submit}
    >
